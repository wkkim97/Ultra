<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Ultra_Admin.master" AutoEventWireup="true" CodeFile="KRPIA.aspx.cs" Inherits="Pages_Report_MOHW_KRPIA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpHolderContent" Runat="Server">
    ...
    <div class="panel panel-topinfo">
        <div class="panel-heading">
            <h1 class="panel-title fl" style="display: inline">KRPIA 보고</h1>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpHolderBottom" Runat="Server">
    <script src="../../../Scripts/Pages/Report/KRPIA.js"></script>
</asp:Content>
