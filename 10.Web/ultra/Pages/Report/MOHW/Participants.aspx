<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Ultra_Admin.master" AutoEventWireup="true" CodeFile="Participants.aspx.cs" Inherits="Pages_Report_MOHW_Participants" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpHolderContent" Runat="Server">
    ...
    <div class="panel panel-topinfo">
        <div class="panel-heading">
            <h1 class="panel-title fl" style="display: inline">학술대회지원</h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpHolderBottom" Runat="Server">
    <script src="../../../Scripts/Pages/Report/Participants.js"></script>
</asp:Content>
