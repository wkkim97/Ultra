<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Ultra_Admin.master" AutoEventWireup="true" CodeFile="MarketResearch.aspx.cs" Inherits="Pages_Report_MOHW_MarketResearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpHolderContent" Runat="Server">
    ...
    <div class="panel panel-topinfo">
        <div class="panel-heading">
            <h1 class="panel-title fl" style="display: inline">시판 후 조사</h1>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpHolderBottom" Runat="Server">
    <script src="../../../Scripts/Pages/Report/MarketResearch.js"></script>
</asp:Content>
