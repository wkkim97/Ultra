<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Ultra_Admin.master" AutoEventWireup="true" CodeFile="SampleDevice.aspx.cs" Inherits="Pages_Report_MOHW_Sample_Device" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpHolderContent" Runat="Server">
    ...
    <div class="panel panel-topinfo">
        <div class="panel-heading">
            <h1 class="panel-title fl" style="display: inline">구매전 의료기기 </h1>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpHolderBottom" Runat="Server">
    <script src="../../../Scripts/Pages/Report/SampleDevice.js"></script>
</asp:Content>
