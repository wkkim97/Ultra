<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Ultra_Admin.master" AutoEventWireup="true" CodeFile="DivMedical.aspx.cs" Inherits="Pages_Report_MOHW_DivMedical" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpHolderContent" Runat="Server">
        ...
        <div class="panel-heading">
            <h1 class="panel-title fl" style="display: inline">개별 요양 기관</h1>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpHolderBottom" Runat="Server">
    <script type="text/javascript" src="../../../Scripts/Pages/Report/DivMedical.js"></script>
</asp:Content>
