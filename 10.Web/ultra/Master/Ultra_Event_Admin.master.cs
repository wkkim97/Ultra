...
public partial class Master_Ultra_Event_Admin : System.Web.UI.MasterPage
{
    #region 멤버변수
    ...
    {
        this.tabCostPlan.Visible = divGI_CostPlan.Visible = false;
        this.tabParticipants.Visible = tabEtc.Visible = divGI_Participants.Visible = false;
        this.tabAgenda.Visible = divGI_Agenda.Visible = false;
        this.tabPayment.Visible = false;
