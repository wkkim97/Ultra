...
function loadGrid(item) {
    $("#divAdminApproval").jsGrid({
        ...
        rowDoubleClick: function (args) {
            ...
            //var url = "/ultra/Pages/Event/event_admin.aspx";
            ...
            loadData: function (filter) {
                return $.grep(this.data, function (item) {
                    return (!filter.EVENT_NAME || item.EVENT_NAME.toLowerCase().indexOf(filter.EVENT_NAME.toLowerCase()) > -1)
                        ...
                        && (!filter.PROCESS_STATUS || item.PROCESS_STATUS.toLowerCase().indexOf(filter.PROCESS_STATUS.toLowerCase()) ==0)
